...
Gem::Specification.new do |gem|
  ...
  gem.add_dependency 'railties',      '>= 4.1', '< 6.0'
  gem.add_dependency 'actionpack',    '>= 4.1', '< 6.0'
  gem.add_dependency 'activemodel',   '>= 4.1', '< 6.0'
  gem.add_dependency 'activesupport', '>= 4.1', '< 6.0'
