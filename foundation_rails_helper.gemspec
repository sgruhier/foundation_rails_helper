...
Gem::Specification.new do |gem|
  ...
  gem.add_dependency 'railties',      '~> 4.2', '>= 4.2.0'
  gem.add_dependency 'actionpack',    '~> 4.2', '>= 4.2.0'
  gem.add_dependency 'activemodel',   '~> 4.2', '>= 4.2.0'
  gem.add_dependency 'activesupport', '~> 4.2', '>= 4.2.0'
